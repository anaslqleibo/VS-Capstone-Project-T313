...
function ListView({ title, closeButton = true, ...props }: ListViewProps) {
  ...
  return (
    <div
      className={`w-max text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-lg overflow-hidden text-left ${isShown ? "block" : "hidden"}`}
      ref={containerRef}
    >
