    ...
    return (
      <>
        ...
        <div className="my-auto flex items-center p-4 md:my-1 md:p-0">
          ...
          {/* <Button type="toggle" className="text-sm bg-[rgba(255,255,255,0.1)] w-full p-2">Admin Mode</Button> */}

          <img src={logo} alt="2 Bent Rods logo" className="w-12 m-auto md:m-2 md:w-36"/>
        
        </div>
        <div className="w-12 h-12 hover:bg-[#1e2266] rounded-full md:flex items-center justify-center ml-auto mb-2 hidden" ref={toggleButtonRef} onClick={()=>{setOpen(true)}}>
        ...
        <div className="w-12 h-12 hover:bg-[#1e2266] rounded-full ml-auto mb-2 flex items-center justify-center" ref={toggleButtonRef} onClick={()=>{setOpen(true); setIsMobileMenuOpen(false)}}>
          <img src={notification} alt="Notifications" className="w-6 object-contain" />
        </div>
